...
ALTER TABLE `mdiy_form` MODIFY COLUMN `CREATE_DATE` datetime NULL ON UPDATE CURRENT_TIMESTAMP AFTER `CREATE_BY`;
ALTER TABLE `mdiy_form` MODIFY COLUMN `UPDATE_BY` int(11) NULL AFTER `CREATE_DATE`;
ALTER TABLE `mdiy_form` MODIFY COLUMN `UPDATE_DATE` datetime NULL ON UPDATE CURRENT_TIMESTAMP AFTER `UPDATE_BY`;
...
ALTER TABLE `mdiy_content_model` ADD COLUMN `CREAET_DATE` datetime NULL ON UPDATE CURRENT_TIMESTAMP AFTER `CREATE_BY`;
ALTER TABLE `mdiy_content_model` ADD COLUMN `UPDATE_BY` int NULL AFTER `CREAET_DATE`;	
ALTER TABLE `mdiy_content_model` ADD COLUMN `UPDATE_DATE` datetime NULL ON UPDATE CURRENT_TIMESTAMP AFTER `UPDATE_BY`;
...
ALTER TABLE `mdiy_content_mode_field` ADD COLUMN `CREATE_DATE` datetime NULL ON UPDATE CURRENT_TIMESTAMP AFTER `CREATE_BY`;
ALTER TABLE `mdiy_content_mode_field` ADD COLUMN `UPDATE_BY` int(11) NULL AFTER `CREATE_DATE`;
ALTER TABLE `mdiy_content_mode_field` ADD COLUMN `UPDATE_DATE` datetime NULL ON UPDATE CURRENT_TIMESTAMP AFTER `UPDATE_BY`;
