...
ALTER TABLE diy_form_field CHANGE DFF_ID `FF_ID` int(11) NOT NULL AUTO_INCREMENT COMMENT '字段自增长id';
ALTER TABLE diy_form_field CHANGE DFF_TIPSNAME `FF_TIPSNAME` varchar(30) DEFAULT NULL COMMENT '字段提示文字';
ALTER TABLE diy_form_field CHANGE DFF_FIELDNAME `FF_FIELDNAME` varchar(20) DEFAULT NULL COMMENT '字段名称';
ALTER TABLE diy_form_field CHANGE DFF_TYPE `FF_TYPE` int(11) DEFAULT NULL COMMENT '字段类型（如1.单行，2.多行，3.图片，等）';
ALTER TABLE diy_form_field CHANGE DFF_DEFAULT `FF_DEFAULT` varchar(250) DEFAULT NULL COMMENT '字段的默认值';
ALTER TABLE diy_form_field CHANGE DFF_ISNULL `FF_ISNULL` int(11) DEFAULT NULL COMMENT '字段是否为空';
ALTER TABLE diy_form_field CHANGE DFF_SORT `FF_SORT` int(11) DEFAULT NULL COMMENT '自定义表单的排序';
ALTER TABLE diy_form_field CHANGE DFF_FORMID `FF_FORMID` int(11) DEFAULT NULL COMMENT '字段管理的表单id';
ALTER TABLE `diy_form_field` ADD COLUMN `CREATE_BY` int(11) DEFAULT '0' COMMENT '创建者';
ALTER TABLE `diy_form_field` ADD COLUMN `CREATE_DATE` datetime  COMMENT '创建时间';
ALTER TABLE `diy_form_field` ADD COLUMN `UPDATE_BY` int(11)  DEFAULT '0' COMMENT '更新者';
ALTER TABLE `diy_form_field` ADD COLUMN `UPDATE_DATE` datetime  COMMENT '更新时间';